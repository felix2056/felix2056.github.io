...
<!DOCTYPE html>
<html
    class="js flexbox canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers no-applicationcache svg inlinesvg smil svgclippaths js-focus-visible"
    lang="en" data-js-focus-visible="">
<!--<![endif]-->
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Lato:400,300,300italic,100,700,400italic,900" rel="stylesheet"
        type="text/css">
    ...
    <link rel="stylesheet" href="/css/colors/maroon.css">

    <link rel="stylesheet" href="/css/responsive.css">
    <script src="/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    <link rel="stylesheet" href="/css/switcher.css">
    <link rel="stylesheet alternate" title="maroon" type="text/css" href="/css/colors/maroon.css">
    <link rel="stylesheet alternate" title="blue" type="text/css" href="/css/colors/blue.css">
    <link rel="stylesheet alternate" title="yellow" type="text/css" href="/css/colors/yellow.css">
    <link rel="stylesheet alternate" title="cyan" type="text/css" href="/css/colors/cyan.css">
</head>